...
// Modular Sub-components (Paths verified relative to pages/app/production/)
...
const ProductionBrief: React.FC = () => {
  ...
  if (!shoot) return <div className="p-20 text-center font-serif text-warmgray animate-pulse">Establishing Brief Handshake...</div>;
